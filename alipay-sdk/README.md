...
🎉 [百度小程序第三方 PHP SDK](https://github.com/tmzkj-yii2-shop/baidu-mini-program-sdk)。
...
| 官方 SDK                                                 | 本 SDK                                                    | 链接                                                                                                               |
| :------------------------------------------------------- | :-------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| 无 Composer 集成，自动加载依赖第三方 PHP 框架 `lotusphp` | 集成                                                      | [![Packagist](https://img.shields.io/packagist/v/tmzkj-yii2-shop/alipay-sdk.svg)][Packagist]                              |
| 代码不严谨，各种 Warning                                 | 持续构建，Notice 也不放过                                 | [![Build Status](https://travis-ci.org/tmzkj-yii2-shop/alipay-sdk-php.svg?branch=master)][TravisCI]                       |
| 零单元测试                                               | 99% 测试覆盖率                                            | [![Coverage Status](https://coveralls.io/repos/github/tmzkj-yii2-shop/alipay-sdk-php/badge.svg?branch=master)][Coveralls] |
...
[Packagist]: https://packagist.org/packages/tmzkj-yii2-shop/alipay-sdk
[StyleCI]: https://github.styleci.io/repos/141678964
[TravisCI]: https://travis-ci.org/tmzkj-yii2-shop/alipay-sdk-php
[Coveralls]: https://coveralls.io/github/tmzkj-yii2-shop/alipay-sdk-php?branch=master
...
1. Composer 安装。
    ...
    ```bash
    composer require tmzkj-yii2-shop/alipay-sdk
    ```
